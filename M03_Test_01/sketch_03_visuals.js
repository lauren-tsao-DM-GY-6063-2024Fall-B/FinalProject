 ...
 let sharpControl = -50; // controls the sharpness of the overall shape (lower values = sharper edges, higher values = rounder edges)
 ...
 let uScale = 1000; // controls the uniform scaling of the shape 
 ...
 function mousePressed() {
   ...
   spikeFactor = int(random(80, 100)); // smaller value = simpler, circular or polygonal shapes, larger value = more complex star-like shapes.
