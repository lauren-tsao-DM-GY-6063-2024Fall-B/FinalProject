...
let redInterval = 4000; // Set the interval to 3000ms (3 seconds)
...
function draw() {
  ...
  // Update the position of the red shape every 3 seconds
  if (millis() - lastRedDrawTime > redInterval) {
    ...
    sharpControl = random(20);
    xControl = random(100);
    yControl = random(6);
    uScale = random(300, 400);
